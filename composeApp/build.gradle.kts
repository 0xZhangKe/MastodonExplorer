...
android {
    namespace = "com.zhangke.mastodonexplorer"
    ...
    defaultConfig {
        applicationId = "com.zhangke.mastodonexplorer"
...
compose.desktop {
    application {
        ...
        nativeDistributions {
            ...
            packageName = "com.zhangke.mastodonexplorer"
...
sqldelight {
    databases {
        create("Database") {
            packageName.set("com.zhangke.mastodonexplorer")
        }
    }
}
